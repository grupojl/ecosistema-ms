...
# JobsModule necesita importar ClientsModule con los gRPC clients
# que usan los processors. app.module.ts los registra pero no los exporta.
# Solución: registrar los clients directamente en JobsModule.

cat > "$ROOT/workers-backend/src/jobs/jobs.module.ts" << 'EOF'
...
EOF
ok "workers-backend/src/jobs/jobs.module.ts — ClientsModule registrado localmente"
